...
import { searches } from '../redux/filters/action';

const Navbar = () => {
    const text = useRef('');
    const dispatch = useDispatch();
    const searche = () => {
        dispatch(searches(text.current.value));
    }
    return (
            ...
            <div class="container flex items-center justify-between">
                ...
                <form class="flex items-center">
                    <div class="group relative rounded-md bg-white">
                        ...
                        <input onChange={searche} ref={text} type="text" placeholder="Filter books..." class="search" id="lws-searchBook" />
                    </div>
                </form>
            </div>
        </nav>
